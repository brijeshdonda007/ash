<script src="<?php echo base_url("assets/js/controller/list.js"); ?>"></script>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>Name</label>
                            <input class="form-control" placeholder="Controller Name" name="filterfirstname" id="filterfirstname" type="text" value="<?php echo $filterfirstname; ?>" />
                        </div>
                        <div class="form-group">
            ...
            <div class="card">
                <div class="card-block">
                    <div class="card-title-block">
                        <h3 class="title"> Controller List </h3>
                        <div class="pull-right">
                            <a href="<?php echo getCurUserUrl('addeditcontroller/0'); ?>"><i class="fa fa-plus fa-fw"></i> Add Controller</a>
                        </div>
                    </div>
                    <!-- /.panel-heading -->
