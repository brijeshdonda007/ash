<script src="<?php echo base_url("assets/js/organization/addedit.js"); ?>"></script>
<article class="content forms-page">
    <div class="title-block">
        <h3 class="title"> Manage Organisation </h3>
    </div>
                ...
                <div class="card card-block sameheight-item">
                    ...
                    <form role="form" method="post" id="dataform" name="dataform">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control underlined" placeholder="Organisation Name" name="userfirstname" id="userfirstname" type="text" value="<?php echo $userfirstname; ?>" />
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success"><?php
                            if ($recordId > 0)
                                ...
                                echo 'Save';
                            ?></button>
                        <button type="reset" class="btn btn-danger" onclick="javascript:window.location.href = '<?php echo getCurUserUrl("organizationlist"); ?>';">Back</button>
